...
$.extend(EthiopianCalendar.prototype, {
	...
	regional: { // Localisations
		'': {
			name: 'Ethiopian', // The calendar name
			epochs: ['BEE', 'EE'],
			monthNames: ['መስከረም', 'ጥቅምቲ', 'ሕዳር', 'ታሕሳስ', 'ጥሪ', 'የካቲት',
			'መጋቢት', 'ሚያዝያ', 'ግንቦት', 'ሰነ', 'ሓምለ', 'ነሓሰ', 'ጳጉሜ'],
			monthNamesShort: ['መስከረም', 'ጥቅምቲ', 'ሕድር', 'ታሕሳስ', 'ጥሪ', 'የካቲት',
			'መጋቢት', 'ምያዝያ', 'ግንቦት', 'ሰነ', 'ሓምለ', 'ነሓሰ', 'ጳጉሜ'],
			dayNames: ['ስንበት', 'ሶኒ', 'ሶሉስ', 'ረቡእ', 'ሓሙስ', 'ዓርቢ', 'ቀዳም'],
			dayNamesShort: ['ስን', 'ሶኒ', 'ሰሉ', 'ረቡ', 'ሓሙ', 'ዓር', 'ቕዳ'],
			dayNamesMin: ['ሰን', 'ሶኒ', 'ሰሉ', 'ረቡ', 'ሓሙ', 'ዓር', 'ቕዳ'],
