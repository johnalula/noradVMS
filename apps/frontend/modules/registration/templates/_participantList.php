	...
	<thead>
		...
		<tr class="ui-input-header">
			...
			<th class="ui-inpu-box" style="width:180px;min-width:180px;">
				<input type="text" style="width:180px;min-width:180px;" id="full_name" name="full_name" >
	...
	<tbody>
		...
		<tr class="ui-input-body-header"> 
			...
			<td class="ui-input-body-box" style="width:180px;min-width:180px;">
				<input type="text" style="width:180px;min-width:180px;" id="reference_no" name="reference_no" > 
				<input type="hidden" style="width:180px;min-width:180px;" id="reference_no" name="reference_no" > 
			</td> 
