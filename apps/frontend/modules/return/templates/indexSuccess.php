...
<table>
  ...
  <tbody>
    <?php foreach ($return_tasks as $return_task): ?>
    <tr>
      <td><a href="<?php echo url_for('return/show?id='.$return_task->getId()) ?>"><?php echo $return_task->getId() ?></a></td>
