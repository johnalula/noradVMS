	...
	<div class="ui-list-cont">		
		<div class="ui-main-list-cont">
			<div class="ui-list-header">				
				<h1><img src="<?php echo image_path('icons/details') ?>"><?php echo __('General Setting Dashboard')  ?></h1>				
				...
				<div class="ui-dashboard-container" >	
					<div class="ui-main-content">
						<fieldset class="ui-content-fieldset">
							<legend><img src="<?php echo image_path('icons/details') ?>" ><?php echo ('General Setting')  ?></legend>
