	...
	<div class="ui-list-box-layer">		
		<div class="ui-list-box">
			<div class="ui-list-box-header">
				<h1><img src="<?php echo image_path('setting/home') ?>"><?php echo __('Department')  ?></h1>
			...
			<div class="ui-list-box-content" >		
				...
				<fieldset class="ui-content-fieldset">
					<legend><img src="<?php echo image_path('icons/add_medium') ?>" ><?php echo ('New Department')  ?></legend>
					<div class="ui-list-form-content collaps-detail-box">
						...
						<div class="ui-action-button-box">
							<button  id="saveData" class="ui-action-button" onclick="Javascript:createDepartment();" ><img src="<?php echo image_path('icons/save') ?>" ><?php echo ('Save') ?></button> 
					...
					<div class="ui-tab-container">
						<div id="tabs" class="ui-detail-list-box">
								<ul class="ui-detail" > 
									<li ><a href="#jurisdictionType" ><?php echo ('Existing Department') ?></a></li>
