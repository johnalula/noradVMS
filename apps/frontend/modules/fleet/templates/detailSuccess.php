	...
	<div class="ui-navigation-box">
		<div class="ui-navigation-list">
			...
			<ul class="ui-right-button">
				<li><a href="<?php echo url_for('fleet/detail?task_id='.$sf_request->getParameter('task_id').'&token_id='.$sf_request->getParameter('token_id')) ?>"><button class="ui-next-button"><img src="<?php echo image_path('new_icons/next') ?>">Complete</button></a></li>
			</ul>
			<div class="clearFix"></div>
		</div>
