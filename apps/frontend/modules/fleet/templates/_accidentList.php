...
<table class="" id="locationList" >
	<thead>
		<tr class="">
			...
			<th class="" style="border-right:0px;"><?php echo  ('Accident Type') ?></th>     
			<th class="" style="border-right:0px;"><?php echo  ('Place') ?></th>     
			<th class="" style="border-right:0px;"><?php echo  ('Date') ?></th>     
		...
		<tr class="ui-input-header">
			...
			<th class="ui-inpu-box" style="width:150px;min-width:150px;">
				<input type="text" class="" style="width:150px;min-width:150px;" id="reciept_no" name="reciept_no" >
				<br><span id="item_name_validation" class="error_validation displayNone"><?php echo __('Reciept number is required!') ?></span>	
			</th>     
			<th class="ui-inpu-box" style="width:150px;min-width:150px;">
				<input type="text" class="" style="width:150px;min-width:150px;" id="accident_place" name="accident_place" >
				<br><span id="item_name_validation" class="error_validation displayNone"><?php echo __('Reciept number is required!') ?></span>	
			</th>     
			<th class="ui-inpu-box" style="width:100px;min-width:100px;">
				<input type="text" class="" style="width:100px;min-width:100px;" id="accident_date" name="accident_date" >
				<br><span id="item_name_validation" class="error_validation displayNone"><?php echo __('Reciept number is required!') ?></span>	
			</th>     
			...
			<th class="" style="padding:0px 0px;text-align:center;border-left:0px solid #ccc;">
				 <span class="" style=""><a href='#' onclick="" class='candidateVehicleModal' rel='#candidateAccidentVehiclePrompts'>
			...
			<th class="ui-action-triger" style="width:48px;min-width:48px;padding:0px 0px;text-align:left;border-left:1px solid #ccc;">
				 <div class="ui-action-triger-button" style="padding:0px!important;"><a href='#' onclick="Javascript:createAccident(<?php echo $sf_request->getParameter('task_id') ?>);" class='' rel='#'>
