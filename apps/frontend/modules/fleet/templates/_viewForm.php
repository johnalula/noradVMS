...
<table class="autoWidth" style="margin-left:10px;margin-top:5px;" id="detailTable" >
	<tbody style="width:40%;"> 
		<tr>
			...
			<td>
				<input type="text" style="width:200px;" id="customer_name" name="customer_name" value="<?php echo $task->firstName.' '. $task->fatherName.' '. $task->grandFatherName ?>" >	
		...
		<tr>
			...
			<td>
				<input style="width:120px;" id="reference_no" name="reference_no" value="<?php echo $task->reference_no ?>" >		
		...
		<tr>
			...
			<td>
				<input style="width:120px;" id="date" name="date" value="<?php echo $task->start_date ?>" >		
		...
		<tr>
			...
			<td>
				<textarea style="width:200px;" rows=1 id="description" name="description" ><?php echo $task->description ?> </textarea>		
			</td>
		</tr>
		<tr>
