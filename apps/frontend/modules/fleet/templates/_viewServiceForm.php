...
<table class="autoWidth" style="margin-left:10px;margin-top:5px;" id="detailTable" >
	<tbody style="width:40%;"> 
		<tr>
			...
			<td>
				<input style="width:180px;" id="destination" name="destination" value="<?php echo $taskObj->destination ?>" >		
		...
		<tr>
			...
			<td>
				<input style="width:50px;text-align:right;margin-right:9px;" id="no_of_days" name="no_of_days" value="<?php echo $taskObj->service_number_of_days ?>" >		
				<?php echo __('Cost') ?>:<span class="ui-mandatory"></span>
				<input style="width:70px;text-align:right;" id="agreement_cost" name="agreement_cost" value="<?php echo $taskObj->service_agreement_cost ?>">		
				</span>
				<br><span id="reference_no_validation" class="error_validation displayNone"><?php echo __('Reference No is required!') ?></span>	
			</td> 
		</tr> 
		...
		<tr>
			...
			<td>
				<textarea style="width:180px;" rows=2 id="service_reason" name="service_reason" ><?php echo $taskObj->service_reason ?></textarea>		
			</td>
		</tr>
