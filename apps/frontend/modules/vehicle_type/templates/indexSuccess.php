...
<div id="ui-display-error-cont" class="ui-error-data displayNone"> 
	<div class="ui-error-box btn-danger">
		<div class="ui-error-list">
			<?php echo 'Vehicle type already existed!' ?>
...
<div id="ui-display-success-cont" class="ui-success-data displayNone"> 
	<div class="ui-success-box btn-danger">
		<div class="ui-success-list">
			<?php echo 'Vehicle type successfuly saved!' ?>
...
<div id="ui-display-delete-cont" class="ui-success-data displayNone"> 
	<div class="ui-success-box btn-danger">
		<div class="ui-success-list">
			<?php echo 'Vehicle type successfuly deleted!' ?>
			<span class="ui-success-close">X</span>
		</div>			
	</div> 
</div>
	...
	<div class="ui-list-cont">		
		<div class="ui-main-list-cont">
			<div class="ui-list-header">				
				<h1><img src="<?php echo image_path('new_icons/oil') ?>"><?php echo __('Vehicle Type')  ?></h1>		
				...
				<div class="ui-main-content-cont" >	
					<div class="ui-main-content">
						<fieldset class="ui-content-fieldset">
							<legend><img src="<?php echo image_path('icons/add_small') ?>" ><?php echo ('New Vehicle Type')  ?></legend>
...
<div class="ui-container">
	<div class="ui-list-cont">		
		<div class="ui-main-list-cont" >
			<div class="ui-list-header">				
				<h1><img src="<?php echo image_path('icons/list_small') ?>"><?php echo __('Existing Vehicle Types')  ?></h1>				
				<div class="clearFix"></div>
			</div><!-- end of ui-list-header -->
				...
				<div class="ui-main-content-cont" >
					<div class="ui-content-list-box">
						...
						<div class="ui-content-lists">
							<?php include_partial('list', array('vehicle_types' => $vehicle_types )) ?>
...
<script>
	...
	function createVehicleType()
	{
		...
		if( name == '')
		{
			...
			$.ajax({
				...
				url: '<?php echo url_for('vehicle_type/createVehicleType')?>', 
	...
	function deleteVehicleType(fuelID)
	{
		$.ajax({
			data: 'fuel_type_id='+fuelID,
			url: '<?php echo url_for('vehicle_type/deleteVehicleType')?>', 
				success: function(data) { 
					deleteSuccess(); 
				},
				error: function(msg) {
