...
abstract class BaseTaskFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'fuel_acquire_id'          => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'fuel_acquire_id'          => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
