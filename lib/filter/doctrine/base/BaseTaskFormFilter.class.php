...
abstract class BaseTaskFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'total_cost'             => new sfWidgetFormFilterInput(),
      ...
      'is_delay_payable'       => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      ...
      'is_delayed'             => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'total_cost'             => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      ...
      'is_delay_payable'       => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      ...
      'is_delayed'             => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
