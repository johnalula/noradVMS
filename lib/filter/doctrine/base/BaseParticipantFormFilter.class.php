...
abstract class BaseParticipantFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'participant_contact_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('ParticipantContact'), 'column' => 'id')),
      ...
      'birth_date'             => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'participant_contact_id' => 'ForeignKey',
      'vat_number'             => 'Text',
      'project_no'             => 'Number',
