...
abstract class BaseItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'seatng_capacity'      => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'seatng_capacity'      => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
