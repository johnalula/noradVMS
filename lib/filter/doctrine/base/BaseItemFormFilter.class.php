...
abstract class BaseItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'assigned_date'         => new sfWidgetFormFilterInput(),
      ...
      'is_temporary_assigned' => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      ...
      'is_maintened'          => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'is_temporary_assigned' => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      ...
      'is_maintened'          => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
  ...
  public function getFields()
  {
    return array(
      ...
      'is_temporary_assigned' => 'Boolean',
      'is_assigned'           => 'Boolean',
      'is_departed'           => 'Boolean',
      'is_returned'           => 'Boolean',
      'is_maintened'          => 'Boolean',
