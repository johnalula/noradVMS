...
/**
 * ServiceVehicleItemAcqAssignmentOrderuired filter form base class.
 *
 * @package    noradVMS
 * @subpackage filter
 ...
 */
abstract class BaseServiceVehicleItemAcqAssignmentOrderuiredFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('service_vehicle_item_acq_assignment_orderuired_filters[%s]');
