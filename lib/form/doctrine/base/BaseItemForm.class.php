...
abstract class BaseItemForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'task_order_id'        => new sfWidgetFormInputText(),
      ...
      'sitting_capacity'     => new sfWidgetFormInputText(),
      'engine_no'            => new sfWidgetFormInputText(),
      'chesis_no'            => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'task_order_id'        => new sfValidatorInteger(),
      'category_id'          => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Category'), 'required' => false)),
      'category_group_id'    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('CategoryGroups'), 'required' => false)),
      ...
      'sitting_capacity'     => new sfValidatorInteger(array('required' => false)),
      'engine_no'            => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'chesis_no'            => new sfValidatorString(array('max_length' => 100, 'required' => false)),
