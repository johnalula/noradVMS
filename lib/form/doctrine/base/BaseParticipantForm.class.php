...
abstract class BaseParticipantForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'participant_type_id'    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ParticipantType'), 'add_empty' => false)),
      ...
      'participant_contact_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ParticipantContact'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'participant_type_id'    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('ParticipantType'))),
      ...
      'participant_contact_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('ParticipantContact'), 'required' => false)),
      ...
      'birth_date'             => new sfValidatorInteger(array('required' => false)),
      'job_title'              => new sfValidatorString(array('max_length' => 50, 'required' => false)),
      'dean_name'              => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      ...
      'participant_id'         => new sfValidatorInteger(array('required' => false)),
