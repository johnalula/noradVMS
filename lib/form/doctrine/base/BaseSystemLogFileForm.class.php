...
abstract class BaseSystemLogFileForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'deleted_data'   => new sfWidgetFormInputText(),
      'created_data'   => new sfWidgetFormInputText(),
      'viewed_data'    => new sfWidgetFormInputText(),
      'edited_data'    => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'deleted_data'   => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'created_data'   => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'viewed_data'    => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'edited_data'    => new sfValidatorString(array('max_length' => 100, 'required' => false)),
