...
/**
 * TaskPassengers form base class.
 *
 * @method TaskPassengers getObject() Returns the current form's model object
 *
 * @package    noradVMS
 * @subpackage form
 ...
 */
abstract class BaseTaskPassengersForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'passenger_role' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'passenger_role' => new sfValidatorInteger(array('required' => false)),
      'description'    => new sfValidatorString(array('required' => false)),
    ));

    $this->widgetSchema->setNameFormat('task_passengers[%s]');
