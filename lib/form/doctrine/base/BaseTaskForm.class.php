...
abstract class BaseTaskForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'fuel_acquire_id'          => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'departure_mileage'        => new sfValidatorNumber(array('required' => false)),
      'return_mileage'           => new sfValidatorNumber(array('required' => false)),
      'difference_mileag'        => new sfValidatorNumber(array('required' => false)),
      'fuel_acquire_id'          => new sfValidatorInteger(array('required' => false)),
