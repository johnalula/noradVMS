...
abstract class BaseTaskForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'total_cost'             => new sfWidgetFormInputText(),
      ...
      'is_delay_payable'       => new sfWidgetFormInputCheckbox(),
      ...
      'is_delayed'             => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'total_cost'             => new sfValidatorNumber(array('required' => false)),
      ...
      'is_delay_payable'       => new sfValidatorBoolean(array('required' => false)),
      ...
      'is_delayed'             => new sfValidatorBoolean(array('required' => false)),
