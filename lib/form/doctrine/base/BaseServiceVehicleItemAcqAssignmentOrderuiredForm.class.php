...
/**
 * ServiceVehicleItemAcqAssignmentOrderuired form base class.
 *
 * @method ServiceVehicleItemAcqAssignmentOrderuired getObject() Returns the current form's model object
 *
 * @package    noradVMS
 * @subpackage form
 ...
 */
abstract class BaseServiceVehicleItemAcqAssignmentOrderuiredForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('service_vehicle_item_acq_assignment_orderuired[%s]');
  ...
  {
    return 'ServiceVehicleItemAcqAssignmentOrderuired';
  }
