...
/**
 * AssignmentOrder form base class.
 *
 * @method AssignmentOrder getObject() Returns the current form's model object
 *
 * @package    noradVMS
 * @subpackage form
 ...
 */
abstract class BaseAssignmentOrderForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'participant_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Driver'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('assignment_order[%s]');
